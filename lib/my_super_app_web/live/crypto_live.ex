defmodule MySuperAppWeb.CryptoLive do
  ...
  def handle_info(:load_cryptos, socket) do
    ...
    {:noreply, assign(socket, usdt_pairs: usdt_pairs)}
  end
    ...
    <span>
      ...
      <form phx-submit="open_position" class="mb-6">
        ...
        <div class="mb-4">
          ...
          <input type="number" step="0.01" name="quantity" id="quantity" class="block w-full p-2 border border-gray-300 rounded-md shadow-sm text-gray-900">
        </div>
